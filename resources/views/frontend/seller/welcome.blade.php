...
<head>
    ...
    <!-- Template CSS -->
    <link rel="stylesheet" href="{{ asset('/assets/seller/')}}/assets/css/style-starter.css">
</head>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-8 col-sm-10 mt-lg-0 mt-5">
                <div class="img-effect text-lg-center">
                    <img src="{{ asset('/assets/seller/')}}/assets/images/pic1.png" alt="banner" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="products-content">
                            <div class="row">
                                <div class="col-lg-3 col-sm-6 mt-4">
                                    <div class="content">
                                        <a href="#url">
                                            <img src="{{ asset('/assets/seller/')}}/assets/images/1.png" class="img-fluid" alt="">
                                ...
                                <div class="col-lg-3 col-sm-6 mt-4">
                                    <div class="content">
                                        <a href="#url">
                                            <img src="{{ asset('/assets/seller/')}}/assets/images/2.png" class="img-fluid" alt="">
                                            <div class="lte-item-descr text-center">
                                                <ul class="star-rating d-flex justify-content-center">
                                                    <li>
                                                        <a href="#">
                                ...
                                <div class="col-lg-3 col-sm-6 mt-4">
                                    <div class="content">
                                        <a href="#url">
                                            <img src="{{ asset('/assets/seller/')}}/assets/images/3.png" class="img-fluid" alt="">
                                            <div class="lte-item-descr text-center">
                                                <ul class="star-rating d-flex justify-content-center">
                                                    <li>
                                                        <a href="#">
                        ...
                        <div class="products-content">
                            <div class="row">
                                <div class="col-lg-3 col-sm-6 mt-4">
                                    <div class="content">
                                        <a href="#url">
                                            <img src="{{ asset('/assets/seller/')}}/assets/images/4.png" class="img-fluid" alt="">
                                            <div class="lte-item-descr text-center">
                                                <ul class="star-rating d-flex justify-content-center">
                                                    <li>
                                                        <a href="#">
                                ...
                                <div class="col-lg-3 col-sm-6 mt-4">
                                    <div class="content">
                                        <a href="#url">
                                            <img src="{{ asset('/assets/seller/')}}/assets/images/5.png" class="img-fluid" alt="">
                                            <div class="lte-item-descr text-center">
                                                <ul class="star-rating d-flex justify-content-center">
                                                    <li>
                                                        <a href="#">
                                ...
                                <div class="col-lg-3 col-sm-6 mt-4">
                                    <div class="content">
                                        <a href="#url">
                                            <img src="{{ asset('/assets/seller/')}}/assets/images/6.png" class="img-fluid" alt="">
                                            <div class="lte-item-descr text-center">
                                                <ul class="star-rating d-flex justify-content-center">
                                                    <li>
                                                        <a href="#">
                        ...
                        <div class="products-content">
                            <div class="row">
                                <div class="col-lg-3 col-sm-6 mt-4">
                                    <div class="content">
                                        <a href="#url">
                                            <img src="{{ asset('/assets/seller/')}}/assets/images/7.png" class="img-fluid" alt="">
                                            <div class="lte-item-descr text-center">
                                                <ul class="star-rating d-flex justify-content-center">
                                                    <li>
                                                        <a href="#">
                                ...
                                <div class="col-lg-3 col-sm-6 mt-4">
                                    <div class="content">
                                        <a href="#url">
                                            <img src="{{ asset('/assets/seller/')}}/assets/images/8.png" class="img-fluid" alt="">
                                            <div class="lte-item-descr text-center">
                                                <ul class="star-rating d-flex justify-content-center">
                                                    <li>
                                                        <a href="#">
                                ...
                                <div class="col-lg-3 col-sm-6 mt-4">
                                    <div class="content">
                                        <a href="#url">
                                            <img src="{{ asset('/assets/seller/')}}/assets/images/9.png" class="img-fluid" alt="">
                                            <div class="lte-item-descr text-center">
                                                <ul class="star-rating d-flex justify-content-center">
                                                    <li>
                                                        <a href="#">
    ...
    <div class="container py-lg-5 py-md-4">
        <div class="row bottom-ab-grids">
            ...
            <div class="col-lg-6 bottom-right-grids mt-lg-0 mt-5">
                <img src="{{ asset('/assets/seller/')}}/assets/images/pic3.png" alt="" class="img-fluid" />
            </div>
        </div>
    </div>
    </div>
    ...
    <div class="container py-md-5 py-4">
        ...
        <div class="row stats-con">
            ...
            <div class="col-lg-4 col-md-6 stats_info counter_grid mt-md-0 mt-5">
                ...
                <h4>26+ years of experience.Benefit’s of working with us.</h4>
            </div>
        ...
        <div class="container py-md-5">
            ...
            <div class="content-photo-grids row">
                ...
                <div class="photo-6-inf-left col-lg-5 pr-lg-4 text-lg-right text-center">
                    <a href="#"><img src="{{ asset('/assets/seller/')}}/assets/images/pic4.png" class="img-fluid" alt=""></a>
                </div>
            </div>
            <!-- //row-->
        </div>
            ...
            <div class="testimonial-row">
                <div id="owl-demo1" class="owl-two owl-carousel owl-theme mb-md-3 mb-sm-5 mb-4">
                    <div class="item">
                        <div class="testimonial-content">
                            <div class="testimonial">
                                <div class="test-img">
                                    <img src="{{ asset('/assets/seller/')}}/assets/images/team1.jpg" class="img-fluid" alt="client-img">
                                </div>
                                <blockquote>
                    ...
                    <div class="item">
                        <div class="testimonial-content">
                            <div class="testimonial">
                                <div class="test-img"><img src="{{ asset('/assets/seller/')}}/assets/images/team2.jpg" class="img-fluid"
                                                           alt="client-img">
                                </div>
                                <blockquote>
                                    <q>Lorem ipsum dolor sit amet int consectetur adipisicing elit. Velita beatae
                    ...
                    <div class="item">
                        <div class="testimonial-content">
                            <div class="testimonial">
                                <div class="test-img"><img src="{{ asset('/assets/seller/')}}/assets/images/team3.jpg" class="img-fluid"
                                                           alt="client-img">
                                </div>
                                <blockquote>
                                    <q>Lorem ipsum dolor sit amet int consectetur adipisicing elit. Velita beatae
                    ...
                    <div class="item">
                        <div class="testimonial-content">
                            <div class="testimonial">
                                <div class="test-img"><img src="{{ asset('/assets/seller/')}}/assets/images/team4.jpg" class="img-fluid"
                                                           alt="client-img">
                                </div>
                                <blockquote>
                                    <q>Lorem ipsum dolor sit amet int consectetur adipisicing elit. Velita beatae
...
<section class="w3l-footer">
    <footer class="footer-28 py-5">
            ...
            <div class="footer-top-28 text-center">
                <div class="row foothny-grids mb-lg-5 mb-4">
                    <div class="col-lg-6 fotter-gd-left px-0">
                        <a href="#"><img src="{{ asset('/assets/seller/')}}/assets/images/footer.jpg" class="img-fluid" alt=""></a>
                    </div>
        ...
        <div class="midd-footer-28 align-center mt-lg-0 mt-4">
            <p class="copy-footer-28 text-center"> &copy; 2020 FoodyElvent. All Rights Reserved. Design by <a
                    href="https://applielvent.fr/">AE</a></p>
    ...
    <script src="{{ asset('/assets/seller/')}}/assets/js/jquery-3.3.1.min.js"></script> <!-- Common jquery plugin -->

    <script src="{{ asset('/assets/seller/')}}/assets/js/theme-change.js"></script><!-- theme switch js (light and dark)-->
    <!-- responsive tabs -->
    <script src="{{ asset('/assets/seller/')}}/assets/js/jquery-1.9.1.min.js"></script>

    <script src="{{ asset('/assets/seller/')}}/assets/js/easyResponsiveTabs.js"></script>
    ...
    <!-- //counter-->
    <script src="{{ asset('/assets/seller/')}}/assets/js/owl.carousel.js"></script><!-- owl carousel -->
    ...
    <!--bootstrap-->
    <script src="{{ asset('/assets/seller/')}}/assets/js/bootstrap.min.js"></script>
    <!-- //bootstrap-->
